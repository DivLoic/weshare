...
<div class="window_dashboard">
	<div class="header_window_dashboard"><h2>Commentaires d'annonce</h2></div>
	
	<div class="content_window_dashboard">
		<div class="select_all"><input type="checkbox" /></div><div class="all_selected">Tout sélectionner/désélectionner</div><div class="search_users"><form action="index.php?target=comments_item" method="post"><input type="text" placeholder="Recherche par annonce" name="search_annonce" style="width: 170px; margin-right: 15px;"/></form><form action="index.php?target=comments_item" method="post"><input type="text" placeholder="Recherche par contenu ou pseudo" name="search"/></form></div>
			<form action="index.php?target=comments_item_update" method="post">
